...
class Doc(models.Model):
    ...
    birth_date = models.CharField(
        verbose_name='Дата рождения YYMMDD', default='951229', max_length=20)
    ...
    photo_doc = models.ImageField('Фото в паспорт', upload_to='cfg/input/')
    get_exif_info = models.ImageField(
        verbose_name='Загрузить фото для копирования EXIF', upload_to='cfg/exif_tool/', null=True)
    background = models.BooleanField('Включить фон', default=False)
    background_image = models.ImageField(
        verbose_name='Загрузить фон', upload_to='cfg/background_image/', null=True)
